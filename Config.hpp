...
//typedef sdsl::wm_int<bit_vector> table_column_type;
//typedef sdsl::wm_int<bit_vector, rank_support_v<>, select_support_mcl<>, select_support_mcl<0>> table_column_type;
typedef sdsl::wm_int<rrr_vector<15>> table_column_type;
